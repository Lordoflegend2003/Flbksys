...
export default function Admin() {
  ...
  return (
    <>
      <Navbarr />
      <h1 className="text-3xl mb-10 mt-5 font-semibold leading-normal text-center text-gray-900 dark:text-white text-center">
        Welcome to admin panel
      </h1>
      <h1 className=" text-2xl font-semibold mb-5 text-gray-900 text-center">
